...
public abstract class JSWriteFrameSlotNode extends FrameSlotNode implements WriteNode {
    ...
    public InstrumentableNode materializeInstrumentableNodes(Set<Class<? extends Tag>> materializedTags) {
        if (materializedTags.contains(WriteVariableTag.class) || materializedTags.contains(StandardTags.WriteVariableTag.class) || materializedTags.contains(AnalysisTags.WriteVariableTag.class)) {
